...
def generate_reflection(user_message: str, emo: str = "sad") -> str:
    """Generates a reflection response based on the user's message and detected emotion. Uses the Flan-T5 model.
    --------
    Args:
        user_message (str): The user's message to reflect on.
        emo (str): The detected emotion of the user. Defaults to "sad".
    --------
    Returns:
        str: The reflection response generated by the Flan-T5 model.
    """
    prompt = (
...
def generate_recommendation(user_input_1: str, user_input_2: str, bot_response_1: str, actual_emotion: str, desired_emotion: str) -> str:
    """Generates a recommendation based on user inputs and emotions. Uses the Flan-T5 model.
    --------
    Args:
        user_input_1 (str): User input 1.
        user_input_2 (str): User input 2.
        bot_response_1 (str): Bot response 1.
        actual_emotion (str): Detected emotion of the user from the first input.
        desired_emotion (str): Desired emotion of the user from the second input.
    --------
    Returns:
        str: The recommendation response generated by the Flan-T5 model.
    """
    final_prompt = (
        few_shot_prompt +
        f"User: {user_input_1}\n"
