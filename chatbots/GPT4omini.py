...
async def generate_reflection(user_message: str, detected_emotion: str) -> str:
    """
    First interaction: reflect on the user's emotion.
    --------
    Args:
        user_message (str): The user's message to reflect on.
        detected_emotion (str): The emotion detected in the user's message.
    --------
    Returns:
        str: The reflection response generated by the GPT-4o-mini model.
    """
...
async def generate_recommendation(history: list, current_emotion: str, desired_emotion: str) -> str:
    """
    Second interaction: recommend a playlist to help transition from current emotion to desired emotion.
    --------
    Args:
        history (list): Conversation history including user inputs and bot responses.
        current_emotion (str): The current emotion of the user.
        desired_emotion (str): The desired emotion the user wants to achieve.
    --------
    Returns:
        str: The recommendation response generated by the GPT-4o-mini model.
    """
...
async def generate_translation(user_message: str) -> str:
    """
    Translates a user message to English while preserving emotional and context meaning.
    --------
    Args:
        user_message (str): The user's message to translate.
    --------
    Returns:
...
async def rewrite_as_emotion_statement(user_input: str) -> str:
    ...
    --------
    Args:
        user_input (str): The user's message to reformulate.
    --------
    Returns:
        str: The reformulated message as a direct emotional statement.
    """
    messages = [
        {
            "role": "system",
